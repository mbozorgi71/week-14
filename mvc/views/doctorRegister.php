...
<div class="m-5 text-primary">
    ...
    <form action="" method="post">
        ...
        <div class="form-floating mb-3">
            <textarea class="form-control" placeholder=" enter your Educational records" id="floatingTextarea"></textarea>
        ...
        <div class="form-floating mb-3">
            ...
            <textarea class="form-control" placeholder="enter your work experience" id="floatingTextarea"></textarea>

        </div>
        <label   class="form-label"> Type of Activity </label>
        <div class="form-floating mb-3">

            <textarea class="form-control" placeholder=" enter your Type of Activity" id="floatingTextarea"></textarea>
